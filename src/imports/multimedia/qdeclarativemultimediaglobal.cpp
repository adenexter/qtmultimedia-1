...
/*!
    ...
    Note that this property is static; it is not updated when cameras are added or removed from
    ...
    the active camera by clicking on one of the items in the list.

...
/*!
    ...
    When several cameras are present on the system, you can select which one to use by setting
    the \l deviceId property with a value from
    ...
    m_componentComplete(false)
{
    ...
    m_imageCapture = new QDeclarativeCameraCapture(m_camera, m_camera);
    m_videoRecorder = new QDeclarativeCameraRecorder(m_camera, m_camera);
    m_exposure = new QDeclarativeCameraExposure(m_camera, m_camera);
    m_flash = new QDeclarativeCameraFlash(m_camera, m_camera);
    m_focus = new QDeclarativeCameraFocus(m_camera, m_camera);
    m_imageProcessing = new QDeclarativeCameraImageProcessing(m_camera, m_camera);

...
/*!
    ...
    \row \li Camera.ExposureAction        \li Action exposure mode.  Since 5.4
    \row \li Camera.ExposureLandscape     \li Landscape exposure mode.  Since 5.4
    \row \li Camera.ExposureNightPortrait \li Night portrait exposure mode.  Since 5.4
    \row \li Camera.ExposureTheatre       \li Theatre exposure mode.  Since 5.4
    \row \li Camera.ExposureSunset        \li Sunset exposure mode.  Since 5.4
    \row \li Camera.ExposureSteadyPhoto   \li Steady photo exposure mode.  Since 5.4
    \row \li Camera.ExposureFireworks     \li Fireworks exposure mode.  Since 5.4
    \row \li Camera.ExposureParty         \li Party exposure mode.  Since 5.4
    \row \li Camera.ExposureCandlelight   \li Candlelight exposure mode.  Since 5.4
    \row \li Camera.ExposureBarcode       \li Barcode exposure mode.  Since 5.4
